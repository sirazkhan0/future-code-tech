...
if( ! defined( 'WPNW_VERSION' ) ) {
	define( 'WPNW_VERSION', '4.5.1' ); // Version of plugin
}
if( ! defined( 'WPNW_DIR' ) ) {
...
if( ! defined( 'WPNW_PLUGIN_LINK' ) ) {
	define( 'WPNW_PLUGIN_LINK', 'https://www.essentialplugin.com/wordpress-plugins/sp-news-and-scrolling-widgets/?utm_source=WP&utm_medium=News&utm_campaign=Features-PRO#fndtn-lifetime' ); // Plugin Category
}
